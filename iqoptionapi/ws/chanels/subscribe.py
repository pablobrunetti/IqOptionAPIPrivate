...
class Subscribe(Base):
    ...
    def __call__(self, active_id,size):
       #{"name":"subscribeMessage","msg":{"name":"candle-generated","params":{"routingFilters":{"active_id":1,"size":1}}}}
        ...
        data2 = {"name":"client-price-generated", "params": { "routingFilters": {"active_id":str(active_id) } } }
        self.send_websocket_request(self.name, data)
        self.send_websocket_request(self.name, data2)

class Subscribe_digital_profit(Base):
    """Class for IQ option candles websocket chanel."""
    # pylint: disable=too-few-public-methods
    ...
    def __call__(self, active_id,size):       
       data = {"name":"client-price-generated", "params": { "routingFilters": {"active_id":str(active_id) } } }

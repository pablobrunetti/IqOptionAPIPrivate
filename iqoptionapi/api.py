...
class IQOptionAPI(object):  # pylint: disable=too-many-instance-attributes
    ...
    instrument_quites_generated_data2 = {}
...
# ____________________for_______digital____________________
    ...
    @property
    def subscribe_digital_profit(self):
        return Subscribe_digital_profit(self)
	
    @property
    def unsubscribe_digital_profit(self):
        return Unsubscribe_digital_profit(self)
